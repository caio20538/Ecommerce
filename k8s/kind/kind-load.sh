...
docker pull caio20538/api-gateway:latest
docker pull caio20538/product-service:latest
docker pull caio20538/order-service:latest
docker pull caio20538/inventory-service:latest
docker pull caio20538/notfication-service:latest
...
kind load docker-image -n microservices caio20538/api-gateway:latest
kind load docker-image -n microservices caio20538/product-service:latest
kind load docker-image -n microservices caio20538/order-service:latest
kind load docker-image -n microservices caio20538/inventory-service:latest
kind load docker-image -n microservices caio20538/notfication-service:latest